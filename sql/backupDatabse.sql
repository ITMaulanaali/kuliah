...
--Query untuk restore atau memasukan backup ke database nama_database_restore
mysql -u root -p nama_database_yang_akan_di_isi_hasil_backup < /lokasi/database/format.sql;
