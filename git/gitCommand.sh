...
#menerapkan paksa (mengganti semua commit dengan yang sama pada branch remote master)
...
#menghapus atau mengembalikan perubahan file dari yang baru ke awal saat commit terakhir
